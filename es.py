...
inputFile = open(fileName, "r",encoding="utf8")  # open file in read mode , to avoid 'charmap' codec can't decode byte error add encoding of txt file
def letterFrequency (fileName, letter): #define function that has 2 arguments, name of the file and the letter that is being checked 
    ...
    for char in text: 
        ...
        if char == 'e' or 'E': #(check for lower and uppercase e)
